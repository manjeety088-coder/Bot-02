...
from pyrogram import Client, filters, idle  # ✅ idle import kiya hai
import pyromod 
...
async def main():
    ...
    await idle()  # ✅ Pyrogram ka native idle handler
    await user_app.stop()
    await bot_app.stop()
...
if __name__ == "__main__":
    try:
        bot_app.run(main()) # Pyrogram ab apne hisaab se event loop manage karega
    except Exception as e:
...
# ✅ Execution Error Fixed for Render
if __name__ == "__main__":
    try:
        asyncio.run(main())
    except Exception as e:
